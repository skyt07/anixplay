...
const HomeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg
      ...
      fill="currentColor"
      stroke="currentColor"
      className={`w-4 h-4 transition-colors ${props.className || ""}`}
    >
      <path
        ...
        c11.028,0,20-8.996,20-20.053V148.275h19.791c8.436,0,11.066-3.854,11.884-6.151
        C330.615,139.822,331.009,135.161,324.442,129.811z"
      />
    </svg>
  );
};
